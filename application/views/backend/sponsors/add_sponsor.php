<div class="col-sm-10 col-md-11 main">
	<div class="row" >
		<div class="col-sm-12 col-md-12" style="padding-left:0px;">
			<h1 class="page-header"><a href="<?php echo base_url().'admin/sponsors' ?>"><i class="mdi mdi-arrow-left-bold-circle-outline"></i></a> Tạo Sponsor</h1>
		</div>
	</div>
	<div class="row">
			...
			<div  class="form-group">
				...
				<div class="row">
					<div class="col-md-6   date" id='datepicker_ngaytao' >
						...
						<span class="input-group-addon"><span class="mdi mdi-calendar-text"></span>
					</span>	
