			...
			<div  class="form-group">
				...
				<div class="row">
					<div class="col-md-6   date" id='datepicker_ngaytao'>
						<input type="text"  class="form-control" name="date_start" data-date-format="DD-MM-YYYY" value="<?php echo set_value('time_start', date('d-m-Y', strtotime($sponsor->time_start))); ?>">
				...
				<div class="col-md-6  date" id='timepicker_ngaytao'>
					<input type="text"  class="form-control" name="time_start" data-date-format="HH:mm" value="<?php echo set_value('time_start', date('H:i', strtotime($sponsor->time_start))); ?>">
