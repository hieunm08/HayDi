                ...
                <tbody>
                  ...
                  ?>
                     ...
                     <tr>
                      ...
                      <td><?php echo $this->user->showRole($user->role) ?></td>
                      <td><?php echo $this->user->showStatus($user->blocked) ?></td>
                      <td style="text-align:center">
                        <div class="btn-group" role="group">
                            <?php if($user->blocked == 1){?>
                                <a href="<?php echo base_url('admin/members/unblock_member/'.$user->id); ?>" class="btn btn-default btn-xs active"><span class="icon-plus" style="color:blue"></span> Khóa</a>
                            <?php }else{?>
                                <a href="<?php echo base_url('admin/members/block_member/'.$user->id); ?>" class="btn btn-default btn-xs"><span class="icon-minus" style="color:blue"></span> Mở khóa</a>
                            <?php }?>
