 <div class="col-sm-10 col-md-11 main">
     ...
     <div class="row">
         ...
         <?php foreach ($bookings_guider as $booking): ?>
            <?php echo form_open('admin/bookings/edit_guider_booking/'.$this->uri->segment(4)); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" disabled class="form-control" name="type" value="<?php echo ( $booking->guider_id ) ?>">
                <?php echo form_error('customer'); ?>
            </div>
            <div  class="form-group">
        ...
        <div  class="form-group">
         ...
         <div class="form-group">
                <label for="item_type"> Tổng giờ</label>
                <input type="text" disabled class="form-control" name="hours" value="<?php echo ( $booking->hours ) ?>">
                <?php echo form_error('customer'); ?>
            </div>
        <div  class="form-group">
                <label for="dateandtime">Thời gian hẹn</label>
                <div class="row">
                    <div class="col-md-6   date" id='datepicker_ngayhen'>
                        <input type="text"  class="form-control" name="time_meet" data-date-format="DD-MM-YYYY" value="<?php echo set_value('from_start_date', date('d-m-Y', strtotime($booking->time_meet))); ?>">
                        <span class="input-group-addon"><span class="icon-calendar"></span>
                    </span>
                    <?php echo form_error('from_start_date'); ?>
                </div>
                <script type="text/javascript">
                $(function () {
                $('#datepicker_ngayhen').datetimepicker({
                pickTime: false,
                useCurrent: false
                });
                });
        ...
        <div class="form-group">
            <label for="item_type">Địa điểm hẹn</label>
            <input type="text" class="form-control" name="address_meet" value="<?php echo ( $booking->address_meet) ?>">
            <?php echo form_error('customer'); ?>
        </div>
         <div class="form-group">
            <label for="item_type">Lat</label>
            <input type="text" class="form-control" name="lat" value="<?php echo ( $booking->lat) ?>">
            <?php echo form_error('customer'); ?>
        </div>
         <div class="form-group">
            <label for="item_type">Lon</label>
            <input type="text" class="form-control" name="lon" value="<?php echo ( $booking->lon) ?>">
            <?php echo form_error('customer'); ?>
        </div>
        <div class="form-group">
            <label for="customer">Ghi chú</label>
            <textarea rows="4" cols="50"  class="form-control"  name="note" ><?php echo ( $booking->note ) ?> </textarea>
        </div>
        <div class="form-group">
